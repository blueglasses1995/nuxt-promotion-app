...
module.exports = {
  ...
  */
  head: {
    title: 'Programming Courses | Toshiki Matsukuma',
    meta: [
      { charset: 'utf-8' },
      { name: 'viewport', content: 'width=device-width, initial-scale=1' },
      { hid: 'description', name: 'description', content: process.env.npm_package_description || '' },
      { hid: 'og:title', name: 'og:title', content: 'Learn from amazing courses | Toshiki Matsukuma' },
      ...
      { hid: 'og:description', name: 'og:description', content: 'I am Toshiki Matsukuma an passionate software engineer and freelance developer.' },
    ],
    link: [
